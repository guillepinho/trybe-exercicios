...
const sendMarsTemperature = (func, errorHandler) => {
    const isError = Math.floor(Math.random() * 100);
    if (isError > 60) return errorHandler('Robot is busy');
    setTimeout(() => {
...
// sendMarsTemperature(blank); // imprime "Mars temperature is: 20 degree Celsius", por exemplo
