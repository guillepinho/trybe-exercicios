...
INSERT INTO boxoffice(movie_id, rating, domestic_sales, international_sales) VALUES
	((SELECT id FROM movies WHERE id = 8), 8.5, 300000000, 250000000),
    ((SELECT id FROM movies WHERE id = 10), 7.4, 460000000, 510000000),
    ((SELECT id FROM movies WHERE id = 11), 9.9, 290000000, 280000000);
