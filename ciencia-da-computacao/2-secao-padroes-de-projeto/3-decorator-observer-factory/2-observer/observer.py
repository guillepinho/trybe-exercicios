...
class Perfil:
    ...
    def get_sistemas_de_notificacao(self):
    ...
    def remover_sistema_de_notificao(self, sistema):
...
if __name__ == "__main__":
    ...
    notificacao_email = NotificadorEmail(meuPerfil, seguidores_email)

    meuPerfil.adicionar_post("Olá universo da programação!")

    meuPerfil.remover_sistema_de_notificao(notificacao_email)

    meuPerfil.adicionar_post("Novo teste")
